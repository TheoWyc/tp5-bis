public class Portefeuille
{
    ...
    /**
     * Cette fonction vous permet de transférer des devises du portefeuille actuel vers le portefeuille de destination
     * pour le montant indiqué. Le type de devise (nom du Jeton) doit être le même entre les deux portefeuilles et le
     * montant du portefeuille actuel doit être supérieur ou égal à celui indiqué.
     *
     * @param destination
     * @param montantJetons
    ...
    /**
     * Cette fonction vous permet d'acheter des jetons de la crypto-devise en fonction de leur valeur en euros. Le
     * résultat est l'augmentation des jetons de la crypto-monnaie.
     *
     * @param montantEuros
    ...
    /**
     * Valide si le proprietaire passé en parametre est celui qui as le portefeuille
     *
     * @param proprietaire
    ...
    /**
     * @return La valeur en euros du src.Portefeuille. Autrement dit, le monant de jetons multiplié par la valeur des
     * 		jetons.
     */
    ...
    {
        return String.format("%10s", proprietaire) + " : " + String.format("%10.1f",
                montant) + " x " + this.monnaie.toString() + " = " + String.format("%10.1f", valeurEnEuros());
    }
